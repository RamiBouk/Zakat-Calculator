...
class ChameuxPage extends StatefulWidget {
  const ChameuxPage({Key? key}) : super(key: key);

  @override
  State<ChameuxPage> createState() => _ChameuxPageState();
}

class _ChameuxPageState extends State<ChameuxPage> {
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                        image: AssetImage("images/animal-camel.png"),
                        fit: BoxFit.fitWidth),
                  ),
                ),
                Padding(
                  ...
                  child: Container(
                      ...
                      child: Material(
                          ...
                          child: Column(children: [
                            ...
                            FormLib.myText('Nombre des chameaux:'),
                            SizedBox(
                              height: 10,
                            ),
                            FormLib.myTextField(
                                controller: Values.camelController,
                                autofocus: true,
                                last: true),
                            SizedBox(
                              height: 10,
